                  ...
                  <Grid item
                    ...
                    <Select
                      ...
                      onChange={(e) => handleProvinceChange(e)}>
                        <MenuItem
                          style={{color:"#294243"}}>Alberta</MenuItem>
                        <MenuItem
                          style={{color:"#294243"}}>British Columbia</MenuItem>
                        <MenuItem
                          style={{color:"#294243"}}>Quebec</MenuItem>
                        <MenuItem
                          style={{color:"#294243"}}>Manitoba</MenuItem>
                        <MenuItem
                          style={{color:"#294243"}}>New Brunswick</MenuItem>
                        <MenuItem
                          style={{color:"#294243"}}>Newfoundland and Labrador</MenuItem>
                        <MenuItem
                          style={{color:"#294243"}}>Nova Scotia</MenuItem>
                        <MenuItem
                          style={{color:"#294243"}}>Prince Edward Island</MenuItem>
                        <MenuItem
                          style={{color:"#294243"}}>Saskatchewan</MenuItem>
                        <MenuItem
                          style={{color:"#294243"}}>Yukon</MenuItem>
                    </Select>
